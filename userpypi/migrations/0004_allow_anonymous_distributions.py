...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('userpypi_mirrorlog', 'created', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'MirrorLog.created'
        db.alter_column('userpypi_mirrorlog', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
