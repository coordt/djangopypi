...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Distribution.uploader'
        db.alter_column('userpypi_distribution', 'uploader_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Distribution.uploader'
    ...
    models = {
        ...
        'userpypi.mirrorlog': {
            ...
            'releases_added': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'mirror_sources'", 'blank': 'True', 'to': "orm['userpypi.Release']"})
        },
        'userpypi.package': {
